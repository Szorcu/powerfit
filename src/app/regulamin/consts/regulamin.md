...
3. **2.3.** Użytkownik ma prawo dostępu do treści swoich danych oraz ich poprawiania, usunięcia, ograniczenia przetwarzania, przenoszenia danych, a także prawo wniesienia sprzeciwu wobec ich przetwarzania.
4. **2.4.** Dane osobowe mogą być przekazywane podmiotom współpracującym z Power Fit sp. z o.o., w tym eFitness sp. z o.o., wyłącznie w zakresie niezbędnym do realizacji usług i na podstawie odpowiednich umów powierzenia przetwarzania danych.
...
3. **3.3.** Na terenie siłowni obowiązuje stosowanie odpowiedniego stroju sportowego oraz zmiana obuwia na czyste, zakryte buty sportowe. **Zabrania się korzystania z klapek, sandałów, butów na obcasie oraz innego obuwia nieprzystosowanego do ćwiczeń.**
4. **3.4.** Każdy klient zobowiązany jest do posiadania własnego ręcznika i używania go podczas ćwiczeń.
5. **3.5.** Po zakończeniu ćwiczeń należy uporządkować stanowisko, odłożyć sprzęt na miejsce i zdezynfekować urządzenia.
...
3. **4.3.** Wszelkie urazy lub wypadki należy natychmiast zgłaszać pracownikom siłowni.
4. **4.4.** Personel ma prawo odmówić wstępu osobie, której stan wskazuje na spożycie alkoholu lub substancji psychoaktywnych.
